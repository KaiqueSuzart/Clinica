...
export default function TreatmentPlanModal({ 
  ...
  const getProgress = () => {
    ...
    const completed = treatmentItems.filter(item => item.status === 'concluido').length;
    return Math.round((completed / treatmentItems.length) * 100);
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                    {treatmentItems.filter(item => item.status === 'concluido').length}
                  </div>
                  <p className="text-sm text-purple-800 dark:text-purple-200">Concluídos</p>
                </div>
              </div>
            </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4 animate-in slide-in-from-top-4 duration-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setNewItem(prev => ({ ...prev, procedure: e.target.value }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                      >
                  ...
                  <div className="flex justify-end space-x-3 mt-4">
                    ...
                    <button
                      ...
                      disabled={!newItem.procedure || !newItem.description}

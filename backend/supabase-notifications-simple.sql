-- =====================================================
-- SISTEMA DE NOTIFICAÇÕES - VERSÃO SIMPLES E SEM ERROS
-- =====================================================
...
INSERT INTO notifications (empresa_id, type, title, message, priority, data) VALUES
  ...
  (gen_random_uuid(), 'appointment', 'Nova consulta agendada', 'Consulta agendada para João Silva', 'normal', '{"patient": "João Silva"}'),
  (gen_random_uuid(), 'system', 'Sistema atualizado', 'Nova versão disponível', 'low', '{"version": "2.0.0"}');

-- 5. CRIAR FUNÇÕES SIMPLES (SEM PARÂMETROS DEFAULT)
-- =====================================================

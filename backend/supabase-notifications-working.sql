-- =====================================================
-- SISTEMA DE NOTIFICAÇÕES - VERSÃO QUE FUNCIONA
-- =====================================================
-- Execute este SQL no Supabase - versão que realmente funciona
-- =====================================================
...
-- Criar políticas usando CREATE OR REPLACE
CREATE OR REPLACE POLICY "notifications_view_policy" ON notifications
  FOR ALL USING (true);

CREATE OR REPLACE POLICY "notifications_insert_policy" ON notifications
  FOR INSERT WITH CHECK (true);

CREATE OR REPLACE POLICY "notifications_update_policy" ON notifications
  FOR UPDATE USING (true);

CREATE OR REPLACE POLICY "notifications_delete_policy" ON notifications

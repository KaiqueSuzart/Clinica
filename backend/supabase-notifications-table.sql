...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  user_id UUID, -- Usuário específico (opcional, se NULL é para todos)
  type VARCHAR(50) NOT NULL, -- 'appointment', 'return', 'message', 'confirmation', 'system'
  ...
  expires_at TIMESTAMP WITH TIME ZONE DEFAULT NULL -- Data de expiração da notificação
);
